...
-- Дамп структуры для таблица auth_dump.account
...
-- Дамп данных таблицы auth_dump.account: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `account` DISABLE KEYS */;
/*!40000 ALTER TABLE `account` ENABLE KEYS */;

-- Дамп структуры для таблица auth_dump.account_access
...
-- Дамп данных таблицы auth_dump.account_access: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `account_access` DISABLE KEYS */;
/*!40000 ALTER TABLE `account_access` ENABLE KEYS */;

-- Дамп структуры для таблица auth_dump.account_banned
...
-- Дамп данных таблицы auth_dump.account_banned: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `account_banned` DISABLE KEYS */;
/*!40000 ALTER TABLE `account_banned` ENABLE KEYS */;

-- Дамп структуры для таблица auth_dump.account_last_played_character
...
-- Дамп данных таблицы auth_dump.account_last_played_character: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `account_last_played_character` DISABLE KEYS */;
/*!40000 ALTER TABLE `account_last_played_character` ENABLE KEYS */;

-- Дамп структуры для таблица auth_dump.account_muted
...
-- Дамп данных таблицы auth_dump.account_muted: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `account_muted` DISABLE KEYS */;
/*!40000 ALTER TABLE `account_muted` ENABLE KEYS */;

-- Дамп структуры для таблица auth_dump.autobroadcast
...
-- Дамп данных таблицы auth_dump.autobroadcast: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `autobroadcast` DISABLE KEYS */;
/*!40000 ALTER TABLE `autobroadcast` ENABLE KEYS */;

-- Дамп структуры для таблица auth_dump.battlenet_accounts
...
-- Дамп данных таблицы auth_dump.battlenet_accounts: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `battlenet_accounts` DISABLE KEYS */;
/*!40000 ALTER TABLE `battlenet_accounts` ENABLE KEYS */;

-- Дамп структуры для таблица auth_dump.battlenet_account_bans
...
-- Дамп данных таблицы auth_dump.battlenet_account_bans: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `battlenet_account_bans` DISABLE KEYS */;
/*!40000 ALTER TABLE `battlenet_account_bans` ENABLE KEYS */;

-- Дамп структуры для таблица auth_dump.battlenet_account_heirlooms
...
-- Дамп данных таблицы auth_dump.battlenet_account_heirlooms: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `battlenet_account_heirlooms` DISABLE KEYS */;
/*!40000 ALTER TABLE `battlenet_account_heirlooms` ENABLE KEYS */;

-- Дамп структуры для таблица auth_dump.battlenet_account_mounts
...
-- Дамп данных таблицы auth_dump.battlenet_account_mounts: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `battlenet_account_mounts` DISABLE KEYS */;
/*!40000 ALTER TABLE `battlenet_account_mounts` ENABLE KEYS */;

-- Дамп структуры для таблица auth_dump.battlenet_account_toys
...
-- Дамп данных таблицы auth_dump.battlenet_account_toys: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `battlenet_account_toys` DISABLE KEYS */;
/*!40000 ALTER TABLE `battlenet_account_toys` ENABLE KEYS */;

-- Дамп структуры для таблица auth_dump.battlenet_item_appearances
...
-- Дамп данных таблицы auth_dump.battlenet_item_appearances: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `battlenet_item_appearances` DISABLE KEYS */;
/*!40000 ALTER TABLE `battlenet_item_appearances` ENABLE KEYS */;

-- Дамп структуры для таблица auth_dump.battlenet_item_favorite_appearances
...
-- Дамп данных таблицы auth_dump.battlenet_item_favorite_appearances: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица auth_dump.battle_pets
...
-- Дамп данных таблицы auth_dump.battle_pets: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `battle_pets` DISABLE KEYS */;
/*!40000 ALTER TABLE `battle_pets` ENABLE KEYS */;

-- Дамп структуры для таблица auth_dump.battle_pet_slots
...
-- Дамп данных таблицы auth_dump.battle_pet_slots: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `battle_pet_slots` DISABLE KEYS */;
/*!40000 ALTER TABLE `battle_pet_slots` ENABLE KEYS */;

-- Дамп структуры для таблица auth_dump.ip_banned
...
-- Дамп данных таблицы auth_dump.ip_banned: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `ip_banned` DISABLE KEYS */;
/*!40000 ALTER TABLE `ip_banned` ENABLE KEYS */;

-- Дамп структуры для таблица auth_dump.logs
...
-- Дамп данных таблицы auth_dump.logs: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `logs` ENABLE KEYS */;

-- Дамп структуры для таблица auth_dump.logs_ip_actions
...
-- Дамп данных таблицы auth_dump.logs_ip_actions: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `logs_ip_actions` DISABLE KEYS */;
/*!40000 ALTER TABLE `logs_ip_actions` ENABLE KEYS */;

-- Дамп структуры для таблица auth_dump.rbac_account_permissions
...
-- Дамп данных таблицы auth_dump.rbac_account_permissions: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `rbac_account_permissions` DISABLE KEYS */;
/*!40000 ALTER TABLE `rbac_account_permissions` ENABLE KEYS */;

-- Дамп структуры для таблица auth_dump.rbac_default_permissions
...
-- Дамп данных таблицы auth_dump.rbac_default_permissions: ~4 rows (приблизительно)
...
-- Дамп структуры для таблица auth_dump.rbac_linked_permissions
...
-- Дамп данных таблицы auth_dump.rbac_linked_permissions: ~659 rows (приблизительно)
...
-- Дамп структуры для таблица auth_dump.rbac_permissions
...
-- Дамп данных таблицы auth_dump.rbac_permissions: ~677 rows (приблизительно)
...
-- Дамп структуры для таблица auth_dump.realmcharacters
...
-- Дамп данных таблицы auth_dump.realmcharacters: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `realmcharacters` DISABLE KEYS */;
/*!40000 ALTER TABLE `realmcharacters` ENABLE KEYS */;

-- Дамп структуры для таблица auth_dump.realmlist
...
-- Дамп данных таблицы auth_dump.realmlist: ~0 rows (приблизительно)
...
INSERT INTO `realmlist` (`id`, `name`, `address`, `localAddress`, `localSubnetMask`, `port`, `icon`, `flag`, `timezone`, `allowedSecurityLevel`, `population`, `gamebuild`, `Region`, `Battlegroup`) VALUES
	(1, 'AshamaneCoreLegacy', '127.0.0.1', '127.0.0.1', '255.255.255.0', 8085, 0, 2, 1, 0, 0, 32638, 1, 1);
/*!40000 ALTER TABLE `realmlist` ENABLE KEYS */;

-- Дамп структуры для таблица auth_dump.updates
...
-- Дамп структуры для таблица auth_dump.updates_include
...
-- Дамп данных таблицы auth_dump.updates_include: 1 rows
/*!40000 ALTER TABLE `updates_include` DISABLE KEYS */;
INSERT INTO `updates_include` (`path`, `state`) VALUES
	('$/sql/ashamane/auth', 'RELEASED');
/*!40000 ALTER TABLE `updates_include` ENABLE KEYS */;

-- Дамп структуры для таблица auth_dump.uptime
...
-- Дамп данных таблицы auth_dump.uptime: ~0 rows (приблизительно)
